...
const importServices = [
  ...
  "Import Clearance for Capital goods under EPCG with NIL duty.",
  "Project Import Clearance.",
  "Import clearance under concessional rate of duty clearance – Annexure –III (EOU).",
  "Import clearance under Hi-tech goods, Served from India Scheme, Target Plus etc.",
  "Import clearance under Remission of Duties and Taxes on Export Products Scheme (RoDTEP) / Duty Free Import Authorization (DFIA).",
  "Import clearance under Bonding / De-bonding / High Sea Sale / Job work.",
