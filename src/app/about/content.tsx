...
const jsonLd = [
  ...
  },
  {
    ...
    "foundingDate": "2000",
    "url": "https://islf.in",
    "description": "AEO certified customs broker and freight forwarder in India, headquartered in Chennai with offices in Bangalore, Tuticorin, Gujarat and Ho Chi Minh City, Vietnam.",
    "hasCredential": {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.p variants={fadeUp} className="text-gray-600 leading-relaxed mb-5">
                Indian Shipping and Logistics Facility Pvt Ltd is one of India's top logistics service providers and shipping companies, headquartered in Chennai with branch offices in Tuticorin, Bangalore, Gujarat and an overseas branch at Ho Chi Minh City, Vietnam.
              </motion.p>
              <motion.p variants={fadeUp} className="text-gray-600 leading-relaxed mb-5">
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { city: "Tuticorin", address: "No.21, New Colony, 2nd Street, Thoothukudi 628003, Tamil Nadu", phone: "+91-0461-2340790 / 91 / 92 / 93 / 94 / 95" },
              { city: "Bengaluru", address: "Flat 101, Saroj Regency, Site 3, MS Reddy Nagar, Marathahalli, Bengaluru 560037", phone: "+91 9538876950" },
              { city: "Gujarat", address: '"Gold Coin" No.202, Plot 321, Ward 12/B, Gandhidham, Kutch, Gujarat 370201', phone: "+91 9538876950" },
              { city: "Vietnam (Overseas)", address: "Ho Chi Minh City, Vietnam", phone: "+84-28-62873031" },
            ].map((office, i) => (
