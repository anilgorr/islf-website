              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm text-white/60">
                    <div className="flex items-start gap-2"><MapPin className="w-4 h-4 text-accent shrink-0 mt-0.5" /><span>Sudharsanam Tower, No.06 & 08,<br />Coral Merchant Street, Mannady,<br />Chennai 600001</span></div>
                    <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-accent shrink-0" /><span>+91-44-2525 1314 / 15 / 16 / 17 / 18</span></div>
                    <div className="flex items-center gap-2"><Mail className="w-4 h-4 text-accent shrink-0" /><span>info@islf.in</span></div>
                  </div>
                </div>
                <div>
                  <p className="text-white font-semibold text-sm mb-2 uppercase tracking-wide">Gujarat Office</p>
